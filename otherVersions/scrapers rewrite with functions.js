...
// main variables
const constantLink = 'https://www.rebuy.de/verkaufen/apple/notebooks/macbook';          // mb we dont need GUT at all?
    ...
    while (modelSwitcher < 3){                                                      // пока что 12 и Эир не нужны
        while(year < maxYear){
            try{
                ...
                if (isNaN(anzeigen) ? worksheet.cell(1, 12).string('unknown amount') : worksheet.cell(1, 12).string('Total: ' + anzeigen)); // here we understand how much available
