...
var defaultTime = 2000;              // 550 w/o doubler // until 14.09 == 750
// variables for excel
const qwerty = 'QWERTY';
const color = [
    'silber', 
    ...
    */
    ...
    async function old15() {
        ...
        while (year < 2020) {
            try {
                ...
                var pageNumber = 1;
                    //https://www.rebuy.de/verkaufen/apple/notebooks/macbook-pro?f_prop_season=2018&f_prop_display_size=15,4%20Zoll&page=2
    ...
    async function old13() {
        try {
            ...
            var link = constantLink + '-pro/13?f_prop_season=2020&page=' + pageNumber;
            await page.goto(link);
    ...
    async function new16() {  // outdated multiple // need to consider cores and page counter does not work, >>> implemented new title parser
        var anzeigeCounter = 1;
